package com.doing.activiti.modeler;
...
import com.doing.common.core.page.PageDomain;
import com.doing.common.core.page.TableDataInfo;
import com.doing.common.core.page.TableSupport;
...
import static com.doing.common.core.domain.AjaxResult.error;
import static com.doing.common.core.domain.AjaxResult.success;
...
public class ModelerController extends BaseController {
    ...
    public TableDataInfo list(ModelEntityImpl modelEntity) {
        ...
        // 条件过滤
        if (com.doing.common.utils.StringUtils.isNotBlank(modelEntity.getKey())) {
            modelQuery.modelKey(modelEntity.getKey());
        }
        if (com.doing.common.utils.StringUtils.isNotBlank(modelEntity.getName())) {
